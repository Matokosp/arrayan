<html>
    ...
    <body>
    <section class="contact-message" id="sectionOne">
        <div class="container">
            <img class="contact-message-icon" src="assets/images/succ.png" alt="">
            <h2>
                ¡Tu mensaje se ha enviado con éxito! <br>
                Nos pondremos en contacto contigo a la brevedad.
            </h2>
        </div>
        <a class="home-back-button" href="index.php">volver a home</a>
    </section>
    <footer>
